...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Google%20Kubernetes%20Engine%20Security%3A%20Binary%20Authorization/ArcadeLabs479.sh
sudo chmod +x ArcadeLabs479.sh
./ArcadeLabs479.sh
```
