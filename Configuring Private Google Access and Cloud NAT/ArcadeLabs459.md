...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Configuring%20Private%20Google%20Access%20and%20Cloud%20NAT/ArcadeLabs459.sh
sudo chmod +x ArcadeLabs459.sh
./ArcadeLabs459.sh
```
