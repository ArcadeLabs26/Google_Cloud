...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Cloud%20Monitoring%3A%20Qwik%20Start/ArcadeLabs089.sh
sudo chmod +x ArcadeLabs089.sh
./ArcadeLabs089.sh
```
