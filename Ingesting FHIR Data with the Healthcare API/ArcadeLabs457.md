...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Ingesting%20FHIR%20Data%20with%20the%20Healthcare%20API/ArcadeLabs457.sh
sudo chmod +x ArcadeLabs457.sh
./ArcadeLabs457.sh
```
