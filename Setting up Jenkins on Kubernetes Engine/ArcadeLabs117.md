...
<h2 align="center">
✨ Setting up Jenkins on Kubernetes Engine || GSP191 ✨
</h2>
...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Setting%20up%20Jenkins%20on%20Kubernetes%20Engine/ArcadeLabs117.sh
sudo chmod +x ArcadeLabs117.sh
./ArcadeLabs117.sh
```
