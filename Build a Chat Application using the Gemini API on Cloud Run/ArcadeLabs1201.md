...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Build%20a%20Chat%20Application%20using%20the%20Gemini%20API%20on%20Cloud%20Run/ArcadeLabs1201.sh
sudo chmod +x ArcadeLabs1201.sh
./ArcadeLabs1201.sh
```
