...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Detect%20and%20Investigate%20Threats%20with%20Security%20Command%20Center/ArcadeLabs1125.sh
sudo chmod +x ArcadeLabs1125.sh
./ArcadeLabs1125.sh
```
