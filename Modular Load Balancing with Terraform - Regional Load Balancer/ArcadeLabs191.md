...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Modular%20Load%20Balancing%20with%20Terraform%20-%20Regional%20Load%20Balancer/ArcadeLabs191.sh
sudo chmod +x ArcadeLabs191.sh
./ArcadeLabs191.sh
```
