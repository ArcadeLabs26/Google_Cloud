...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Dataplex%3A%20Qwik%20Start%20-%20Console/ArcadeLabs1143.sh
sudo chmod +x ArcadeLabs1143.sh
./ArcadeLabs1143.sh
```
