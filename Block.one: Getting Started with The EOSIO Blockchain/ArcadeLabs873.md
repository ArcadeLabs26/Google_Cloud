...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Block.one%3A%20Getting%20Started%20with%20The%20EOSIO%20Blockchain/ArcadeLabs873.sh
sudo chmod +x ArcadeLabs873.sh
./ArcadeLabs873.sh
```
