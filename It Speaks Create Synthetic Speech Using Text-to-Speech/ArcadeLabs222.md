...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/It%20Speaks%20Create%20Synthetic%20Speech%20Using%20Text-to-Speech/ArcadeLabs222.sh
sudo chmod +x ArcadeLabs222.sh
./ArcadeLabs222.sh
```
