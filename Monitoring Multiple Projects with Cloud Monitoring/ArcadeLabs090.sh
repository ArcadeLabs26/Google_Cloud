...
echo
echo -e "${CYAN}${BOLD_TEXT}================================================${RESET}"
echo -e "${YELLOW}${BOLD_TEXT}              Arcade Labs Solution            ${RESET}"
echo -e "${CYAN}${BOLD_TEXT}================================================${RESET}"
echo
...
gcloud compute instances create instance2 --region=$REGION --zone=$ZONE --machine-type=e2-medium
...
echo
echo -e "${YELLOW}${BOLD_TEXT}==============================================${RESET}"
echo -e "${WHITE}${BOLD_TEXT}            Subscribe To Arcade Labs          ${RESET}"
echo -e "${YELLOW}${BOLD_TEXT}==============================================${RESET}"
echo
