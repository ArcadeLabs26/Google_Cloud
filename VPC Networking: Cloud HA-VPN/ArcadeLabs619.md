...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/VPC%20Networking%3A%20Cloud%20HA-VPN/ArcadeLabs619.sh
sudo chmod +x ArcadeLabs619.sh
./ArcadeLabs619.sh
```
