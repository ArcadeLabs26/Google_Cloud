...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Using%20Role-based%20Access%20Control%20in%20Kubernetes%20Engine/ArcadeLabs493.sh
sudo chmod +x ArcadeLabs493.sh
./ArcadeLabs493.sh
```
