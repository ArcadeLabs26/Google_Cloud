...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Distributed%20Load%20Testing%20Using%20Kubernetes/ArcadeLabs182.sh
sudo chmod +x ArcadeLabs182.sh
./ArcadeLabs182.sh
```
