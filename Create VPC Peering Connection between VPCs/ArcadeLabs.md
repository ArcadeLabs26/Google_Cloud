...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Create%20VPC%20Peering%20Connection%20between%20VPCs/ArcadeLabs.sh
sudo chmod +x ArcadeLabs.sh
./ArcadeLabs.sh
```
