...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/VPC%20Flow%20Logs%20-%20Analyzing%20Network%20Traffic/ArcadeLabs212.sh
sudo chmod +x ArcadeLabs212.sh
./ArcadeLabs212.sh
```
- Sink Name: vpc-flows 
