...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Implementing%20Security%20in%20Dataplex/ArcadeLabs1157.sh
sudo chmod +x ArcadeLabs1157.sh
./ArcadeLabs1157.sh
```
