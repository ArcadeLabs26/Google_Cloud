...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Analyze%20Findings%20with%20Security%20Command%20Center/ArcadeLabs1164.sh
sudo chmod +x ArcadeLabs1164.sh
./ArcadeLabs1164.sh
```
