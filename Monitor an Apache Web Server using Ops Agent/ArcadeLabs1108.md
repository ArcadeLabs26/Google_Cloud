...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Monitor%20an%20Apache%20Web%20Server%20using%20Ops%20Agent/ArcadeLabs1108.sh
sudo chmod +x ArcadeLabs1108.sh
./ArcadeLabs1108.sh
```
