...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Fundamentals%20of%20Cloud%20Logging/ArcadeLabs610.sh
sudo chmod +x ArcadeLabs610.sh
./ArcadeLabs610.sh
```
