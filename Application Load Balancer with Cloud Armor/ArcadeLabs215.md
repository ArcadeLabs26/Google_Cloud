...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Application%20Load%20Balancer%20with%20Cloud%20Armor/ArcadeLabs215.sh
sudo chmod +x ArcadeLabs215.sh
./ArcadeLabs215.sh
```
