...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Rate%20Limiting%20with%20Cloud%20Armor/ArcadeLabs975.sh
sudo chmod +x ArcadeLabs975.sh
./ArcadeLabs975.sh
```
