...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Setting%20up%20a%20Private%20Kubernetes%20Cluster/ArcadeLabs178.sh
sudo chmod +x ArcadeLabs178.sh
./ArcadeLabs178.sh
```
