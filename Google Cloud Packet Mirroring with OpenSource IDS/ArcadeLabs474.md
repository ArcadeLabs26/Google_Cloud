...
<h1 align="center">
✨  Google Cloud Packet Mirroring with OpenSource IDS || GSP474  ✨
</h1>
...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Google%20Cloud%20Packet%20Mirroring%20with%20OpenSource%20IDS/ArcadeLabs474.sh
sudo chmod +x ArcadeLabs474.sh
./ArcadeLabs474.sh
```
