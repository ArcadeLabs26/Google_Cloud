...
```bash
curl -LO https://raw.githubusercontent.com/ArcadeLabs26/Google_Cloud/main/Scaling%20Microservices%20Applications%20Migration%20to%20Redis%20Enterprise%20on%20Google%20Cloud/ArcadeLabs1177.sh
sudo chmod +x ArcadeLabs1177.sh
./ArcadeLabs1177.sh
```
